...
define dso_local void @update_map(ptr nocapture noundef %0) local_unnamed_addr #6 {
...
148:                                              ; preds = %132, %12
  ...
  tail call void @set_pixel(i32 noundef %8, i32 noundef %7, i32 noundef %162, i32 noundef 0, i32 noundef 0) #10
  %163 = add nuw nsw i64 %5, 1
  %164 = icmp eq i64 %163, 200000
  br i1 %164, label %3, label %4, !llvm.loop !20
}

declare dso_local void @set_pixel(i32 noundef, i32 noundef, i32 noundef, i32 noundef, i32 noundef) local_unnamed_addr #7

declare dso_local void @flush(...) local_unnamed_addr #7

; Function Attrs: nounwind uwtable
define dso_local void @generate_char_field(ptr nocapture noundef writeonly %0) local_unnamed_addr #6 {
  br label %3
...
3:                                                ; preds = %1, %3
  %4 = phi i64 [ 0, %1 ], [ %8, %3 ]
  %5 = tail call i32 (...) @custom_rand() #10
  %6 = trunc i32 %5 to i8
  %7 = getelementptr inbounds i8, ptr %0, i64 %4
  store i8 %6, ptr %7, align 1, !tbaa !3
  %8 = add nuw nsw i64 %4, 1
  %9 = icmp eq i64 %8, 200000
  br i1 %9, label %2, label %3, !llvm.loop !21
}

declare dso_local i32 @custom_rand(...) local_unnamed_addr #7
...
10:                                               ; preds = %2, %10
  ...
  br i1 %13, label %9, label %10, !llvm.loop !22
}

declare dso_local void @init(...) local_unnamed_addr #7

declare dso_local void @window_exit(...) local_unnamed_addr #7
